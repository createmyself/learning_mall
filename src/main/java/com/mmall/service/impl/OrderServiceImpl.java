...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNum, Integer userId, String path) {
        ...
        String subject = new StringBuilder().append("学习扫码支付,订单号：").append(outTradeNo).toString();
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        if (null == order) {
            return ServerResponse.createByError("非本平台订单，回调忽略");
        }
    ...
    @Override
    public ServerResponse<Boolean> queryOrderPayStatus(Integer userId, Long orderNum) {
        Order order = orderMapper.selectByUserIdAndOrderNum(userId, orderNum);
        if (null == order) {
    ...
    public ServerResponse<String> cancel(Integer userId, Long orderNo) {
        ...
        if (null == order) {
            return ServerResponse.createByError("当前用户，查无此单");
        }
